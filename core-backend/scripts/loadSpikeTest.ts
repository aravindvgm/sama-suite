...
// ── Pool ───────────────────────────────────────────────────────────────────────
// max = CONCURRENCY so every parallel request can hold a live DB connection
// simultaneously.  If the DB cannot satisfy all 50, the pool queues the excess
// and MAX_MS will reflect the true worst-case wait.
